  <?php
    ...
    $consulta='SELECT ClaveLote,Precio,Area,Estado  FROM LOTES WHERE ClaveLote="M01L1"';
  ...
  ?>
  <script type="text/javascript"> document.getElementById("consulta").style.display="none" </script>